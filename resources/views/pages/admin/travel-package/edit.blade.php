        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="{{route('travel-package.update', $item->id)}}", method="POST">
                    ...
                    <div class="form-group">
                        <label for="featured_events">Featured Event</label>
                        <input  type="text" class="form-control", name="featured_events", placeholder="Featured Event", value="{{$item->featured_events}}">
                    </div>
                    <div class="form-group">
